<?php
    ...
    $db->query("CREATE TABLE IF NOT EXISTS games (id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, name varchar(50), title varchar(100), text varchar(1000), indices varchar(1000), times_indices varchar(1000))");
